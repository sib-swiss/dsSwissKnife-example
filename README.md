...
Instructions
------------
You will need a fairly recent computer with at least 12 GB of RAM and the docker and docker-compose software for your platform.
...
This will be followed by about 5 - 10  minutes of package updates, the system will only be available once this process is finished (the progress can be followed in the rserver container in /srv_local/logs/Rserve.log). In the subsequent runs there will still be a wait time of about 5 minutes until all the servers are started.
...
docker exec -it work_rserver_1 /bin/bash
</code>
